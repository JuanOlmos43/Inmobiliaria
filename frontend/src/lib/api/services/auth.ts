...
import type { LoginRequest, LoginResponse, UserProfile, RegisterRequest } from '@/types/api'
...
export const authService = {
    ...
    async register(data: RegisterRequest): Promise<UserProfile> {
        ...
        return apiClient.post<UserProfile, RegisterRequest>(API_ENDPOINTS.REGISTER, requestData)
    },
