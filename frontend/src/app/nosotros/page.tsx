...
export default function NosotrosPage() {
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 animate-fade-in">
              Sobre <span className="text-[#C69B56]">Nosotros</span>
            </h1>
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-96 rounded-2xl overflow-hidden shadow-2xl transform hover:scale-105 transition-transform duration-300">
            <div className="absolute inset-0 bg-gradient-to-br from-[#0A2647] to-[#C69B56] opacity-20"></div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Valor 1 */}
            <div className="bg-gradient-to-br from-[#0A2647] to-[#144272] p-8 rounded-2xl shadow-xl text-white transform hover:scale-105 transition-all duration-300 hover:shadow-2xl">
            ...
            {/* Valor 2 */}
            <div className="bg-gradient-to-br from-[#C69B56] to-[#B38A45] p-8 rounded-2xl shadow-xl text-white transform hover:scale-105 transition-all duration-300 hover:shadow-2xl">
              <div className="text-5xl mb-4">💼</div>
      ...
      {/* Estadísticas */}
      <section className="py-16 bg-gradient-to-r from-[#0A2647] to-[#144272] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div className="transform hover:scale-110 transition-transform duration-300">
              <div className="text-5xl font-bold text-[#C69B56] mb-2">5,000+</div>
              <p className="text-xl text-gray-200">Familias Felices</p>
            </div>
            <div className="transform hover:scale-110 transition-transform duration-300">
              <div className="text-5xl font-bold text-[#C69B56] mb-2">15+</div>
              <p className="text-xl text-gray-200">Años de Experiencia</p>
            </div>
            <div className="transform hover:scale-110 transition-transform duration-300">
              <div className="text-5xl font-bold text-[#C69B56] mb-2">50+</div>
              <p className="text-xl text-gray-200">Profesionales</p>
            </div>
            <div className="transform hover:scale-110 transition-transform duration-300">
              <div className="text-5xl font-bold text-[#C69B56] mb-2">98%</div>
              <p className="text-xl text-gray-200">Satisfacción</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden transform hover:scale-105 transition-all duration-300 hover:shadow-2xl">
            <div className="h-64 bg-gradient-to-br from-[#0A2647] to-[#C69B56] flex items-center justify-center">
              <div className="text-8xl">👨‍💼</div>
            </div>
            <div className="p-6">
              <h3 className="text-2xl font-bold text-[#0A2647] mb-2">Carlos Rodríguez</h3>
              <p className="text-[#C69B56] font-semibold mb-3">Director General</p>
          ...
          {/* Miembro 2 */}
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden transform hover:scale-105 transition-all duration-300 hover:shadow-2xl">
            <div className="h-64 bg-gradient-to-br from-[#C69B56] to-[#B38A45] flex items-center justify-center">
              <div className="text-8xl">👩‍💼</div>
            </div>
            <div className="p-6">
              <h3 className="text-2xl font-bold text-[#0A2647] mb-2">María González</h3>
              <p className="text-[#C69B56] font-semibold mb-3">Gerente de Ventas</p>
              <p className="text-gray-600">
          ...
          {/* Miembro 3 */}
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden transform hover:scale-105 transition-all duration-300 hover:shadow-2xl">
            <div className="h-64 bg-gradient-to-br from-[#0A2647] to-[#144272] flex items-center justify-center">
              <div className="text-8xl">👨‍💻</div>
            </div>
            <div className="p-6">
              <h3 className="text-2xl font-bold text-[#0A2647] mb-2">Juan Pérez</h3>
              <p className="text-[#C69B56] font-semibold mb-3">Asesor Senior</p>
              <p className="text-gray-600">
      ...
      {/* Call to Action */}
      <section className="py-16 bg-gradient-to-r from-[#C69B56] to-[#B38A45] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a 
            href="/contacto" 
            className="inline-block bg-white text-[#0A2647] px-8 py-4 rounded-full font-bold text-lg hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl"
          >
            Contáctanos Ahora
          </a>
        </div>
