        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-fade-in">
              <span className="bg-gradient-to-r from-[#14b8a6] to-[#2dd4bf] bg-clip-text text-transparent">Contáctanos</span>
            </h1>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border-l-4 border-[#14b8a6]">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#0f172a] mb-2">Dirección</h3>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border-l-4 border-[#14b8a6]">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#0f172a] mb-2">Teléfono</h3>
                    <p className="text-gray-600">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border-l-4 border-[#14b8a6]">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#0f172a] mb-2">Email</h3>
                    <p className="text-gray-600">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border-l-4 border-[#14b8a6]">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#0f172a] mb-2">Horarios de Atención</h3>
                    <p className="text-gray-600">
          ...
          <div>
            <div className="bg-white p-6 rounded-2xl shadow-xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                {/* Nombre */}
                <div>
                  <label htmlFor="nombre" className="block text-sm font-semibold text-[#0f172a] mb-1">
                    Nombre Completo *
                  </label>
                  <input
                    type="text"
                    ...
                    required
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#14b8a6] focus:border-transparent transition-all duration-300 bg-white text-gray-900 placeholder-gray-500 text-sm"
                ...
                {/* Teléfono */}
                <div>
                  <label htmlFor="telefono" className="block text-sm font-semibold text-[#0f172a] mb-1">
                    Teléfono
                  </label>
                  <input
                    type="tel"
                ...
                {/* Asunto */}
                <div>
                  <label htmlFor="asunto" className="block text-sm font-semibold text-[#0f172a] mb-1">
                    Asunto *
                  </label>
                  <select
                    id="asunto"
                    ...
                    onChange={handleChange}
                    required
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#14b8a6] focus:border-transparent transition-all duration-300 bg-white text-gray-900 text-sm"
                  >
                ...
                {/* Mensaje */}
                <div>
                  <label htmlFor="mensaje" className="block text-sm font-semibold text-[#0f172a] mb-1">
                    Mensaje *
                  </label>
                  <textarea
                    id="mensaje"
                    ...
                    required
                    rows={4}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#14b8a6] focus:border-transparent transition-all duration-300 resize-none bg-white text-gray-900 placeholder-gray-500 text-sm"
