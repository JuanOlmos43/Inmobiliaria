...
export default function BasePropertyCard({
    ...
    return (
        <div
            className={`bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-[#14b8a6] transform hover:-translate-y-2 animate-scale-in ${className}`}
            onClick={onClick}
        >
            {/* Image Section */}
