...
export default function Icon({
  ...
  // El icono location usa fill en lugar de stroke
  const usesFill = name === "location";

  return (
    <svg
      className={className}
      fill={usesFill ? "currentColor" : fill}
      viewBox="0 0 24 24"
      stroke={usesFill ? "none" : "currentColor"}
      strokeWidth={usesFill ? undefined : strokeWidth}
    >
      {iconPaths[name]}
    </svg>
  );
