...
export default function ValueCard({ icon, title, description, color }: ValueCardProps) {
  ...
  return (
    <div className={`bg-gradient-to-br ${colorClasses} p-8 rounded-2xl shadow-xl text-white transform hover:scale-105 transition-all duration-300 hover:shadow-2xl`}>
      <div className="mb-4">
        {icon}
      </div>
