      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5 px-8 py-6">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-full px-6 py-3 font-bold text-white shadow-lg transition-all duration-300 hover:scale-[0.98] hover:shadow-xl disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:scale-100"
